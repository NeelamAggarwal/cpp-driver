...
Murmur3Partitioner::Token Murmur3Partitioner::get_token(const StringRef& str) {
...
RandomPartitioner::Token RandomPartitioner::get_token(const StringRef& str) {
  Token token;
...
ByteOrderedPartitioner::Token ByteOrderedPartitioner::get_token(const StringRef& str) {
